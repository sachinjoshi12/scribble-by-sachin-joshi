[![Build Status](https://bigbinary.semaphoreci.com/badges/scribble/branches/master.svg?style=shields)](https://bigbinary.semaphoreci.com/projects/scribble)
...
Follow the instructions mentioned [here](https://github.com/bigbinary/scribble/blob/master/docs/using_docker.md) to use docker for development.

## Replace Scribble with your project name

Let's say that the project name is `Pump`. Execute the command below to
replace all occurrences of `Scribble` with `Pump`.

```bash
perl -pi -w -e 's/Scribble/Pump/g;' $(git ls-files)
perl -pi -w -e 's/scribble/Pump/g;' $(git ls-files)
```
...
scribble is maintained by [BigBinary](https://www.BigBinary.com). BigBinary is a software consultancy company. We build web and mobile applications using Ruby on Rails, React.js, React Native and Node.js.
